...
void controle_manual();//Ativa o controle manual dos semáforos, atravez dde um painel localizado em um dos postes proximos ao semaforo. pode ser usado em caso de acidente
